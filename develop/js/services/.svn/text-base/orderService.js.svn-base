        ...
        var services = {
            ...
            getOrderList: function(params){
                var deferred = $q.defer(),
                    URL = "/webapi/index.php?cls=order&fun=list",   //正式接口地址
            ...
            getOrderDetail: function(orderId){
                var deferred = $q.defer(),
                    URL = "/webapi/index.php?cls=order&fun=show_order_detail",   //正式接口地址
            ...
            delOrder: function(orderId){
                var deferred = $q.defer(),
                    URL = "/webapi/index.php?cls=order&fun=cancel&order_id=" + orderId,   //正式接口地址
            ...
            getSaledOrderList: function(params){
                var deferred = $q.defer(),
                    URL = "/webapi/shop/index.php?cls=member_refund&fun=index",
            ...
            getSaledOrderDetail: function(refundId){
                var deferred = $q.defer(),
                    URL = "/webapi/shop/index.php?cls=member_refund&fun=view",   //正式接口地址
            ...
            getSaledProgress: function(refundId){
                var deferred = $q.defer(),
                    URL = "/webapi/shop/index.php?cls=store_deliver&fun=search_deliverInfoOp",   //正式接口地址
