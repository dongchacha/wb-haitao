...
if(window.define){//加个判断兼容
    define(["jquery", 
        "angular", "util", 
        "say", "loading", "confirm", "underscore", "services/userService", "services/cartService",
        ...
        //根controller
        global.controller('GController', ["$rootScope", "$scope", "$timeout", "$filter", "userService", "cartService",
        function($rootScope, $scope, $timeout, $filter, userService, cartService){
            $scope.Util = Util;
